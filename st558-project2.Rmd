...
We have a winning model based on the highest R-Squared value of `r winner`! Our models are not doing that great, and only explain a small percentage of the variation in number of shares, but let's not let that dampen our enthusiasm!   
